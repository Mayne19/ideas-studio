...
def create_project(db: Session, data: ProjectCreate, owner_id: str) -> Project:
    project = Project(
        ...
        source_guidelines=data.source_guidelines,
        internal_linking_guidelines=data.internal_linking_guidelines,
        external_linking_guidelines=data.external_linking_guidelines,
