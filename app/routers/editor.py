...
def get_editor_data(
    ...
    return EditorData(
        ...
        serp_analysis_json=article.serp_analysis_json,
        extracted_sources_json=article.extracted_sources_json,
        content_gap_json=article.content_gap_json,
        source_quality_report_json=article.source_quality_report_json,
        evidence_pack_json=article.evidence_pack_json,
        style_guide_json=article.style_guide_json,
        cannibalization_outline_json=article.cannibalization_outline_json,
        claims_json=article.claims_json,
        fact_check_report_json=article.fact_check_report_json,
        estimated_cost_json=article.estimated_cost_json,
        geo_optimization_json=article.geo_optimization_json,
        structured_data_json=article.structured_data_json,
