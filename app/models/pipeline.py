...
class ProjectPipeline(Base):
    ...
    ideas_day_of_month: Mapped[int | None] = mapped_column(Integer, nullable=True)
    publish_hour_start: Mapped[int | None] = mapped_column(Integer, nullable=True, default=8)
    publish_hour_end: Mapped[int | None] = mapped_column(Integer, nullable=True, default=10)
