                          ...
                          return (
                            ...
                            >
                              <div className="relative h-11 w-11 shrink-0">
                                <span className="absolute inset-x-1 bottom-0 h-8 rounded-[10px] bg-accent/6" />
                                <div className="relative flex h-10 w-10 flex-col items-center justify-center rounded-[10px] border border-border bg-accent/6">
