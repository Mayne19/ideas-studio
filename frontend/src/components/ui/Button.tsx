...
const variants: Record<ButtonVariant, string> = {
  ...
  ghost:
    'border-2 border-border bg-transparent text-primary hover:bg-primary hover:text-bg active:opacity-85',
  danger:
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex shrink-0 items-center justify-center whitespace-nowrap font-medium transition-all duration-150',
